...
export const GLOBAL_FUND_DATASET_GROUPS: DatasetGroup[] = [
  {
    ...
    datasets: [
      ...
      },
      {
        ...
        slug: "grant_implementation_periods",
        description:
